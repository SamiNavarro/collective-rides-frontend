...
// services/user-profile/handlers/get-user-by-id.ts
var get_user_by_id_exports = {};
__export(get_user_by_id_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_user_by_id_exports);
...
async function handler(event) {
  ...
  try {
    ...
    await requireCapability("manage_all_clubs" /* MANAGE_ALL_CLUBS */, `user:${userId}`)(authContext);
