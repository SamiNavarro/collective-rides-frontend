...
// services/ride-service/handlers/ride/create-ride.ts
var create_ride_exports = {};
__export(create_ride_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(create_ride_exports);
...
function validateRequest(obj, requiredFields) {
  ...
  for (const field of requiredFields) {
    if (obj[field] === void 0 || obj[field] === null || obj[field] === "") {
...
var handler = async (event) => {
  console.log("Create ride handler invoked");
