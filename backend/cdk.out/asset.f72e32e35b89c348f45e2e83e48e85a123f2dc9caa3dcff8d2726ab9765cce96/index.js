...
// services/club-service/handlers/membership/leave-club.ts
var leave_club_exports = {};
__export(leave_club_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(leave_club_exports);
