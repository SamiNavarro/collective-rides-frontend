...
// services/ride-service/handlers/user/get-user-rides.ts
var get_user_rides_exports = {};
__export(get_user_rides_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_user_rides_exports);
