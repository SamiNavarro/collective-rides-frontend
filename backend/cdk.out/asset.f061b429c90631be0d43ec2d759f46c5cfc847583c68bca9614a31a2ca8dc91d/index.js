...
// services/club-service/handlers/user/get-memberships.ts
var get_memberships_exports = {};
__export(get_memberships_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_memberships_exports);
