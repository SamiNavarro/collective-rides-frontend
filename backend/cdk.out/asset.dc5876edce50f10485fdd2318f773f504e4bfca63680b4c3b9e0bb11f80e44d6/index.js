...
// services/club-service/handlers/user/get-user-clubs.ts
var get_user_clubs_exports = {};
__export(get_user_clubs_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_user_clubs_exports);
...
async function handler(event) {
  ...
  try {
      ...
      try {
        ...
        if (club) {
          ...
          const hydratedClub = {
            ...
            // Use club ID as slug for Phase 3.1
    ...
    return createSuccessResponse(hydratedClubs, void 0, origin);
  } catch (error) {
