...
// services/ride-service/handlers/participation/leave-ride.ts
var leave_ride_exports = {};
__export(leave_ride_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(leave_ride_exports);
