...
// services/club-service/handlers/invitation/accept-invitation.ts
var accept_invitation_exports = {};
__export(accept_invitation_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(accept_invitation_exports);
...
async function handler(event) {
  ...
  try {
    ...
    const processInput = parseJsonBody(event.body);
    if (!processInput) {
      throw new ValidationError("Request body is required");
    }
