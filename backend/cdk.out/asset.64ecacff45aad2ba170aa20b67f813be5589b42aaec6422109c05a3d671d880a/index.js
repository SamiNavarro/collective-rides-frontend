...
// services/club-service/handlers/invitation/list-invitations.ts
var list_invitations_exports = {};
__export(list_invitations_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(list_invitations_exports);
...
async function handler(event) {
  ...
  try {
    ...
    let limit = INVITATION_CONSTRAINTS.DEFAULT_LIST_LIMIT;
    ...
    if (queryParams.status) {
      if (!Object.values(InvitationStatus).includes(queryParams.status)) {
