...
// services/route-file-service/handlers/analytics/get-analytics.ts
var get_analytics_exports = {};
__export(get_analytics_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(get_analytics_exports);
