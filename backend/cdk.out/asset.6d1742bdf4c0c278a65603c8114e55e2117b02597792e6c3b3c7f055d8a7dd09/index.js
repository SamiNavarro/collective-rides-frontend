...
// services/ride-service/handlers/ride/publish-ride.ts
var publish_ride_exports = {};
__export(publish_ride_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(publish_ride_exports);
