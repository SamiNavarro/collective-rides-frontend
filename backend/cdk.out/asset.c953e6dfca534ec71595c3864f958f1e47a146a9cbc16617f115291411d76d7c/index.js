...
// services/club-service/handlers/update-club.ts
var update_club_exports = {};
__export(update_club_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(update_club_exports);
...
async function handler(event) {
  ...
  try {
    ...
    await requireCapability("manage_all_clubs" /* MANAGE_ALL_CLUBS */, `club:${clubId}`)(authContext);
