...
// services/ride-service/handlers/attendance/update-attendance.ts
var update_attendance_exports = {};
__export(update_attendance_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(update_attendance_exports);
